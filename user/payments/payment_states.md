...
When an order is initiated for a customer purchase a payment is created in the Colibri system. A payment goes through various states while being processed.
...
By default, Colibri automatically handles authorizing the payment for a transaction. For capturing payments, we give you the choice of auto-capturing the payment or manually capturing the payment via the Admin Interface. If you like, you can read further [documentation about auto-capturing payments](/developer/payments#auto-capturing).
