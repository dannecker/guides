...
A Calculator is the component of the Colibri shipping system responsible for calculating the shipping price for each available [Shipping Method](shipping_methods).
